...
![image](https://github.com/user-attachments/assets/1b0fcb0c-1924-4996-b828-86635e9ed20a) @whitehouse i know that @nasa-jpl is signal corps at some level, im just curious 
`The United States Army Signal Corps (USASC) is a branch of the United States Army responsible for creating and managing communications and information systems for the command and control of combined arms forces.` [[wiki]](https://en.wikipedia.org/wiki/United_States_Army_Signal_Corps) or similar 
